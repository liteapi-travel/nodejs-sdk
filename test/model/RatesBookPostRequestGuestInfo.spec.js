...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new lite-api-travel.RatesBookPostRequestGuestInfo();
  });
  ...
  describe('RatesBookPostRequestGuestInfo', function() {
    it('should create an instance of RatesBookPostRequestGuestInfo', function() {
      ...
      //var instance = new lite-api-travel.RatesBookPostRequestGuestInfo();
      //expect(instance).to.be.a(lite-api-travel.RatesBookPostRequestGuestInfo);
    });
